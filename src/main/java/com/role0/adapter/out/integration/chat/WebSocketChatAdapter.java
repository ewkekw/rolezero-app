...
public class WebSocketChatAdapter implements ChatNotificationPort {
    ...
    // private final SimpMessagingTemplate messagingTemplate; -- Omitindo auto-wired temporário.
    ...
    public void notificarNovoParticipante(UUID eventoId, UUID participanteId) {
        ...
        System.out.println("STOMP WebSocket Broadcast: " + payload);
    }
    ...
    public void congelarChatLegalmente(UUID eventoId) {
        ...
        // Invoca o microserviço de Chat (que poderia ser Stream Chat ou camada Node isolada)
        // para abortar o TTL automático do chat e efetuar Dump Físico das mensagens num S3 de retenção jurídica (WORM storage).
