...
public interface WebMapper {
    ...
    // O EventoCardResponse necessita do cálculo cruzado de GPS que é feito na
    // camada de Repository Adapter
    // e entregue no Evento com o transient `distancia` populado, mas o core mapping
    // base fica aqui.
}
