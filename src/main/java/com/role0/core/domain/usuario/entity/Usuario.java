...
public class Usuario {
    ...
    public Usuario(UUID id, String nome) {
        if (id == null) throw new UsuarioDomainException("ID do usuário é obrigatório");
        if (nome == null || nome.isBlank()) throw new UsuarioDomainException("Nome do usuário é obrigatório");
        this.id = id;
        this.nome = nome;
